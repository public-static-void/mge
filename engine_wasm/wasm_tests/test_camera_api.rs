...
pub extern "C" fn test_camera_api() -> i32 {
    ...
    unsafe extern "C" {
        fn set_camera(x: i32, y: i32, w: i32, h: i32, z: i32);
        fn get_camera(out_ptr: *mut u8, out_len: i32) -> i32;
    }

    unsafe {
        // Set camera at x=10, y=20, width=80, height=24, z=5
        set_camera(10, 20, 80, 24, 5);
        ...
        // Expected: {"x":10,"y":20,"width":80,"height":24,"z":5}
        if result != "{\"x\":10,\"y\":20,\"width\":80,\"height\":24,\"z\":5}" {
            return 0;
        }
