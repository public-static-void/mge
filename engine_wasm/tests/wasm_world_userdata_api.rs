...
fn compile_test_wasm() -> NamedTempFile {
    let wasm_bytes = load_wasm_test_artifact("test_world_userdata_api.wasm");
...
#[test]
fn test_wasm_world_userdata_api_bridge() {
    ...
    let result = engine
        .invoke_exported_function("test_world_userdata_api", &[])
        .expect("Failed to call test_world_userdata_api");
