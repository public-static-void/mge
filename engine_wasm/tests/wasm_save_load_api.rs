...
fn compile_test_wasm() -> NamedTempFile {
    let wasm_bytes = load_wasm_test_artifact("test_save_load_api.wasm");
...
#[test]
fn test_wasm_save_load_api_bridge() {
    ...
    let result = engine
        .invoke_exported_function("test_save_load_api", &[])
        .expect("Failed to call test_save_load_api");
