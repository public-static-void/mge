...
impl GridLayout {
    ...
    pub fn new(cell_size: (i32, i32), spacing: (i32, i32)) -> Self {
        ...
        // races, but this is safe because GridLayout::new() is called only from the single-threaded
        // UI construction context. The GridLayout type is Send (not Sync), so concurrent access
